...
$blogs_total_count = Accounts::where('group_id', 4)->where('active', 1)->where('brand', 1)->count();
$blogs = Accounts::where('group_id', 4)->where('active', 1)->where('brand', 1)->with('me_signed')->take($blogs_limit)->get();
?>
                ...
                <div class="dashboard-tab">
                    <div class="reg-content__left">
                        @if(isset($top_bloggers) && count($top_bloggers))
                            <div class="left-title">Top brands</div>
                            <ul class="blog-list">
