            ...
            <div class="grid_12 reg-content">
                <div class="dashboard-tab">
                    <div class="reg-content__left new-post-form">
                        ...
                        {{ Form::model($post,array('route'=>array('moderator.promo.update',$post->id),'method'=>'put','class'=>'newpost-form js-ajax-form')) }}
                        <div class="top__select-block form__input-block">
                            <div class="form__input-title">Дата начала публикации</div>
                            {{ Form::text('start_date',(new myDateTime())->setDateString($post->start_date)->format('m/d/Y'),array('class'=>'us-input js-datepicker')) }}
                        </div>
                        <div class="top__select-block form__input-block">
                            <div class="form__input-title">Дата окончания публикации</div>
                            {{ Form::text('stop_date',(new myDateTime())->setDateString($post->stop_date)->format('m/d/Y'),array('class'=>'us-input js-datepicker')) }}
                        </div>
                        <div class="top__select-block form__input-block">
