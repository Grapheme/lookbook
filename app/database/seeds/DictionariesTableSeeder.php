...
class DictionariesTableSeeder extends Seeder {
    ...
    public function run(){
        ...
        DicVal::create(array('dic_id'=>$dic_id,'slug'=>'organization.order.closed-join','name'=> 'Заказ <a href="[link]">№[order]</a> закрыт. Все сотрудники Вашей организации успешно прошли итоговые тестирование по заданным курсам.<br>Для получения сканированных копий документов Ваших сотрудников пройдите по <a href="[link]">ссылке</a>. Для получения оригиналов документов отправьте Почтой России, подписанные с Вашей стороны в 2-х экземплярах договор на оказание платных образовательных услуг и акт о выполнении работ.','order'=>33));
        DicVal::create(array('dic_id'=>$dic_id,'slug'=>'individual.order.closed-join','name'=> 'Заказ <a href="[link]">№[order]</a> закрыт. Вы успешно прошли итоговые тестирование по заданным курсам.<br>Для получения сканированных копий документов пройдите по <a href="[link]">ссылке</a>. Для получения оригиналов документов отправьте Почтой России, подписанные с Вашей стороны в 2-х экземплярах договор на оказание платных образовательных услуг и акт о выполнении работ.','order'=>34));
